...
public class SourcesFromBytecodeGenerator {
  ...
  private static final String METHOD_BODY = " /* compiled code */ ";
  private static final String COMMENT =
      "\n // Failed to get sources. Instead, stub sources have been generated.\n // Implementation of methods is unavailable.\n";
  private static final String TAB = "    ";

  public static String generateSource(IType type) throws JavaModelException {
  ...
  private static void generateType(IType type, StringBuilder builder, String indent)
  ...
  private static void appendAnnotationLabels(
  ...
  private static void appendAnnotationLabel(
      IAnnotation annotation, long flags, StringBuilder builder) throws JavaModelException {
    builder.append('@');
    ...
    for (int i = 0; i < memberValuePairs.length; i++) {
      ...
      builder.append(memberValuePair.getMemberName());
      builder.append('=');
  ...
  private static void appendAnnotationValue(
      ...
      switch (valueKind) {
        ...
        case IMemberValuePair.K_CHAR:
          if (value instanceof Character) {
            builder.append(ASTNodes.getEscapedCharacterLiteral((Character) value));
          }
          break;
        default:
   ...
   */
  private static void appendTypeParametersLabels(
   ...
   */
  private static void appendTypeParameterSignaturesLabel(
      String[] typeParamSigs, StringBuilder builder) {
  ...
  private static void appendTypeArgumentSignaturesLabel(
  ...
  private static void appendTypeSignatureLabel(
    ...
    switch (sigKind) {
      ...
      case Signature.CLASS_TYPE_SIGNATURE:
        String baseType = getSimpleTypeName(typeSig);
      ...
      case Signature.TYPE_VARIABLE_SIGNATURE:
        builder.append(getSimpleTypeName(typeSig));
        break;
  ...
  private static void appendTypeBoundsSignaturesLabel(
      IJavaElement enclosingElement, String[] typeArgsSig, long flags, StringBuilder builder) {
    for (int i = 0; i < typeArgsSig.length; i++) {
      if (i > 0) {
        builder.append(" | "); // $NON-NLS-1$
   ...
   */
  private static String getSimpleTypeName(String typeSig) {
  ...
  private static String getJavaType(IType type) throws JavaModelException {
    if (type.isAnnotation()) {
      return "@interface";
    }
    if (type.isClass()) {
  ...
  private static String getModifiers(int flags, int typeFlags) {
