...
import org.eclipse.che.jdt.ls.extension.api.dto.externallibrary.ExternalLibrariesParameters;
import org.eclipse.che.jdt.ls.extension.api.dto.externallibrary.JarEntry;
...
public class LibraryChildrenCommand {
  ...
  public static List<JarEntry> execute(List<Object> parameters, IProgressMonitor pm) {
    ...
    try {
      return LibraryNavigation.getPackageFragmentRootContent(
          params.getProjectUri(), params.getNodeId(), pm);
