...
public final class JavaElementLabels {
  ...
  public static String getElementLabel(IJavaElement element, long flags) {
    ...
    return org.eclipse.jdt.internal.core.manipulation.util.Strings.markJavaElementLabelLTR(
        result.toString());
  }
  ...
  public static void getLocalVariableLabel(
      ILocalVariable localVariable, long flags, StringBuilder builder) {
  ...
  public static void getInitializerLabel(
      IInitializer initializer, long flags, StringBuilder builder) {
  ...
  public static void getTypeParameterLabel(
      ITypeParameter typeParameter, long flags, StringBuilder builder) {
   ...
   * StringBuilder}. Considers the D_* flags.
   *
  ...
  public static void getDeclarationLabel(
      IJavaElement declaration, long flags, StringBuilder builder) {
  ...
  public static void getCompilationUnitLabel(
      ICompilationUnit cu, long flags, StringBuilder builder) {
  ...
  public static void getPackageFragmentLabel(
      IPackageFragment pack, long flags, StringBuilder builder) {
    new JavaElementLabelComposer(builder).appendPackageFragmentLabel(pack, flags);
  }

  /**
   * Appends the label for a package fragment root to a {@link StringBuilder}. Considers the ROOT_*
   * flags.
   *
  ...
  public static void getPackageFragmentRootLabel(
      IPackageFragmentRoot root, long flags, StringBuilder builder) {
  ...
  public static String getContainerEntryLabel(IPath containerPath, IJavaProject project)
    ...
    if (container != null) {
      return org.eclipse.jdt.internal.core.manipulation.util.Strings.markLTR(
